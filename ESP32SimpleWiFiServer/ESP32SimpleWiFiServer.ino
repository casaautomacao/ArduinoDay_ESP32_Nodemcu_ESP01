/*
  ...
  http://192.168.0.106/H turns the LED on
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print(analogRead(35));//pot
            client.print(",");
            ...
            client.print(celsius);//som
            client.print(",");
            client.print(4095 - analogRead(36)); //ldr
